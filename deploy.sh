...
then
    ...
    docker build -t messaging:$IMAGE_TAG .
    docker tag messaging:$IMAGE_TAG 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-messaging-api:$IMAGE_TAG

    # Push image to 
    docker push 482053628475.dkr.ecr.eu-central-1.amazonaws.com/usupport-messaging-api:$IMAGE_TAG
